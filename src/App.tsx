...
export default function App() {
  ...
  useEffect(() => {
    fetchModels().then(mods => {
      setModels(mods)
      if (mods.length > 0) setSelectedModel(mods.find(m => m.includes('e4b')) || mods[mods.length - 1])
    })
  }, [fetchModels])
    ...
    <div className="flex flex-col h-screen bg-white dark:bg-zinc-950 text-gray-900 dark:text-zinc-100 overflow-hidden">
      ...
      <header className="flex items-center px-4 py-3 bg-gray-50 dark:bg-zinc-900 border-b border-gray-200 dark:border-zinc-800 shrink-0">
        ...
        <div className="flex items-center gap-3 flex-1">
          ...
          <div>
            <h1 className="text-sm font-bold">Gemma 4 Playground</h1>
                ...
                {messages.length === 0 && !isStreaming && (
                  <div className="flex flex-col items-center justify-center h-full gap-5 text-center select-none">
                    ...
                    <div className="space-y-1.5">
                      <h2 className="text-2xl font-bold text-gray-900 dark:text-zinc-100">Gemma 4 is ready</h2>
